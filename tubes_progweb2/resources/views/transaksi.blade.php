                        ...
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                              ...
                              @if (Auth::user()->role == 'member')
                                <li class="active"> <a href="{{url('Transaksi')}}">Transaksi</a> </li>
                      ...
                      <tbody>
                        @foreach ($transaksi as $transaction)
                          <tr>
                            ...
                            <td>{{ $transaction->bahanbakar->name_bb }}</td>
                            <td>{{ $transaction->liter }}</td>
                            <td>{{ number_format($transaction->bahanbakar->price_bb) }}</td>
