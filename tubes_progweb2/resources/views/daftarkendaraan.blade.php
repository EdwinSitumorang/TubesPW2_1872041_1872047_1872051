       ...
       <div class="brand_color">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2><u>Daftar Kendaraan</u></h2><br/><br/>

                        <div class="card-body">
                            <form method="POST" action="{{ url('daftarkendaraan') }}">
                                @csrf
                                ...
                                <div class="form-group row">
                                    <label for="jenis_kendaraan" class="col-md-4 col-form-label text-md-right">{{ __('Jenis Kendaraan') }}</label>

                                    <div class="col-md-6">
                                        <select id="jenis_kendaraan" type="jenis_kendaraan" class="form-control @error('jenis_kendaraan') is-invalid @enderror" name="jenis_kendaraan" value="{{ old('jenis_kendaraan') }}" required autocomplete="role">PIlih Jenis Kendaraan
