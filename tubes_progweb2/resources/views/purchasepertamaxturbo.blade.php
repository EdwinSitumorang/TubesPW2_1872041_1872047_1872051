            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ url('Purchasepertamaxturbo') }}">
                                @csrf
                                ...
                                <input type="hidden" name="id_bb" value="{{ $pertamaxturbo->id_bb }}">
                                  <script type="text/Javascript">
                                  $('#liter').on('change', () => {$('#total').val({{ $pertamaxturbo->price_bb }} * $('#liter').val())})
                                  </script>
