...
class BahanBakarController extends Controller
{
    ...
    {
      $Pertamaxturbo = BahanBakar::Where('name_bb','Pertamax Turbo')->First();
      // dd(Auth::user()->id);
      return view('purchasepertamaxturbo',['pertamaxturbo'=>$Pertamaxturbo]);
    }
    ...
    {
      $Pertamaxturbo = MemberKendaraan::find(Auth::user()->memberkendaraan->no_plat)->get();
      // dd(Auth::user()->id);
      return view('purchasepertamaxturbo',['pertamaxturbo'=>$Pertamaxturbo]);
    }
